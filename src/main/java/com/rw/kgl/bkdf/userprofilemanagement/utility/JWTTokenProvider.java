package com.rw.kgl.bkdf.userprofilemanagement.utility;
...
public class JWTTokenProvider {
  ...
  private JWTVerifier getJWTVerifier() {
    ...
    try {
      ...
      JWTVerifier = JWT.require(algorithm).withIssuer(SecurityConstant.BK_DF).build();
